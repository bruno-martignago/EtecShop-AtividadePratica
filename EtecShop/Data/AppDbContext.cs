...
{
    new Categoria() { Id = 1, Nome = "Livros e papelaria" },
    new Categoria() { Id = 2, Nome = "Games e PC Gamer" },
    new Categoria() { Id = 3, Nome = "Informática" },
    new Categoria() { Id = 4, Nome = "Smartphones" },
    new Categoria() { Id = 5, Nome = "Eletrodomesticos e Casa" },
    new Categoria() { Id = 6, Nome = "Beleza e Perfumaria" },
    new Categoria() { Id = 7, Nome = "Móveis e Decoração" }
};
        ...
        List<Produto> produtos = new()
{
    ...
    new Produto(){
        ...
        Descricao = "Entre no Grishaverso: visite, em Ravka, um mundo de magia e superstiçã, onde nem tudo é o que parece ser! Os três livros da aclamada Trilogia Sombra e ossos – que originou a série da Netflix –, agora reunidos em um box especial",
        Preco = 144.54M,
        Estoque = 23,
        CategoriaId = 1,
